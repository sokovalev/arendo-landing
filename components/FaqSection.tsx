      ...
      <div className="max-w-3xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-muted-foreground">
            Ответы на популярные вопросы о сервисе ZenRent для управления
        ...
        <Accordion type="single" collapsible className="w-full">
          <AccordionItem value="item-1">
            <AccordionTrigger>Для кого предназначен ZenRent?</AccordionTrigger>
            <AccordionContent>
              ZenRent создан специально для частных владельцев недвижимости,
              которые сдают небольшое количество объектов недвижимости. Если вы
              управляете недвижимостью и хотите автоматизировать процессы — этот
              сервис для вас.
            </AccordionContent>
          </AccordionItem>
          ...
          <AccordionItem value="item-6">
            ...
            <AccordionContent>
              Да, в ZenRent есть возможность создавать договоры аренды по
              заранее настроенным шаблонам. Система автоматически подставит
              данные арендаторов, сроки и суммы платежей. Все шаблоны
              соответствуют актуальному законодательству и регулярно
              обновляются.
            </AccordionContent>
          </AccordionItem>
          ...
          <AccordionItem value="item-8">
            ...
            <AccordionContent>
              ...
              основную информацию о квартире (адрес, количество комнат,
              площадь), загружаете фотографии и документы. После этого можно
              добавить данные об арендаторе, условиях аренды и настроить
          ...
          <AccordionItem value="item-9">
            <AccordionTrigger>
              Есть ли мобильное приложение ZenRent?
            </AccordionTrigger>
            <AccordionContent>
              На первом этапе ZenRent будет доступен как веб-приложение, которое
